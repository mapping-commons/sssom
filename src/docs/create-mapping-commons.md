...
- First, create a virtual environment of your choice (anaconda, venv, pyenv, poetry etc.). If you need assistance with virtual environments, [here's a guide to best practices](https://berkeleybop.github.io/best_practice/python_environments) to help you navigate through this vast topic.
