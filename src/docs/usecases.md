...
- [Various data model mappings](https://github.com/microbiomedata/nmdc-schema/tree/main/sssom),
  e.g. MIXS, GOLD, etc
...
- SNOMED-NCIT
  [example](https://docs.google.com/spreadsheets/d/18luA05E9wLukOFamsRV3FWVnoCr57o8qAHe-aGYrPr8/edit#gid=509055704)
...
- Decentralized curation of mappings, especially ones that aren't incident to
  ontology terms

## Clinical mappings

[Gdocs](https://docs.google.com/document/d/1p7MVn0UGro6SMgnCfi70BOYgrDRoNkEjpXXAl8_hYXw/edit)
for discussion.
