...
The SSSOM standard defines the following serialisation formats for storing and
exchanging mapping sets:
...
Implementations MUST support the SSSOM/TSV format. They MAY support the other
formats.
