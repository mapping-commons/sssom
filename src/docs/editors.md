...
This triggers a GitHub Action workflow that releases the new version of SSSOM to
PyPi.
...
- Automated: Every time a pull request is merged into the `main` branch, a
  github action is triggered to deploy documentation automatically.
